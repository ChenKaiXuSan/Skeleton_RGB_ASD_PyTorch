#!/bin/bash
#PBS -N sam3d_dhs_split5
#PBS -t 0-4
#PBS -o logs/pegasus/sam3d_dhs_part_${PBS_SUBREQNO}.log
#PBS -e logs/pegasus/sam3d_dhs_part_${PBS_SUBREQNO}_err.log
#PBS -A SSR
#PBS -q gpu
...
VIDEO_PATH="/work/SSR/share/data/asd_dataset/skeleton_rgb_dataset/split_video/DHS/${TARGET_SPLIT}"
RESULT_PATH="/work/SSR/share/data/asd_dataset/skeleton_rgb_dataset/sam3d_body_results/DHS"
